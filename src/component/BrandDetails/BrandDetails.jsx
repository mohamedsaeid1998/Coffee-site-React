...
let param = useParams()
  ...
  <Helmet>
    ...
    {Products? 
      <div className="container-fluid container-lg   pt-4">
        ...
        {Products.result.map((product)=><div key={product.id} className='col-lg-2 col-md-3'>
  ...
  <Link to={`/productDetails/${product.id}`}>
      ...
      <h6 className='fw-bold mb-0'><span className='text-muted'>Country :</span> <span className='text-capitalize text-white'>{product.countryOfOrigin}</span></h6>
